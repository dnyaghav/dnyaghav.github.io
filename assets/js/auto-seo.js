(function () {
  ...
  const MAX_KEYWORDS = 7, MAX_TITLE_LEN = 60, MAX_DESC_LEN = 155, MIN_WORD_LEN = 3;
  ...
  try {
    ...
    console.info("auto-seo injected:", { title, description, keywords, ogImage });
  } catch (err) {
    console.warn("auto-seo error:", err.message);
  }
})();
